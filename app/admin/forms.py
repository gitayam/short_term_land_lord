"""Forms for admin functionality including site settings and user management."""
...
class SiteSettingsForm(FlaskForm):
    ...
    # Feature toggles
    enable_guest_reviews = BooleanField(
        'Enable Guest Reviews',
        default=False,
        description=(
            "Allow property owners and managers to add guest reviews"
        )
    )
