...
Revision ID: df032aadd9cf
Revises: dd6012cf26dd
Create Date: 2025-03-30 18:22:34.122248
...
revision = 'df032aadd9cf'
down_revision = 'dd6012cf26dd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('category', sa.Enum('CLEANING', 'BATHROOM', 'KITCHEN', 'BEDROOM', 'LAUNDRY', 'GENERAL', 'APPLIANCES', 'CLEANING_TOOLS', 'LINENS', 'ELECTRONICS', 'OUTDOOR', 'FURNITURE', 'DECOR', 'SAFETY', 'MAINTENANCE', 'OTHER', name='itemcategory'), nullable=False),
    ...
    sa.Column('rating', sa.Enum('BAD', 'OK', 'GOOD', name='guestreviewrating'), nullable=False),
