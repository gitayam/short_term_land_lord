...
Revision ID: cb0d5c79abef
Revises: 
Create Date: 2025-03-30 11:19:45.851654
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('PROPERTY_OWNER', 'CLEANER', 'MAINTENANCE', 'ADMIN', name='userroles'), nullable=False),
